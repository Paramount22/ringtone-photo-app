        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <!-- Left Side Of Navbar -->
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('ringtones') }}">{{ __('Ringtones') }}</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('wallpapers.index') }}">{{ __('Wallpapers') }}</a>
                    </li>
                </ul>
                ...
                @else
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="{{ route('ringtones.create') }}">
                                Add ringtone
                            </a>
